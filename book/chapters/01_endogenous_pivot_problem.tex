...
Grammar-constrained decoding systems---PICARD for SQL, Outlines for
...
In process mining, analysts discover a process model from an event log
...
\begin{enumerate}[label=\textbf{(\arabic*)},itemsep=6pt]
  ...
  \item \textbf{Mirage gap.}\;
    ...
    preservation drops to $0.35$, producing a mirage gap of $0.65$.
