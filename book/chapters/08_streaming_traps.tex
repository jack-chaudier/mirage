...
By a classical result on record spacings \citep[Chapter~5]{nevzorov2001},
the number of unit gaps among the first $n$ observations converges in
distribution to a Poisson random variable with parameter $\lambda = 1$.
