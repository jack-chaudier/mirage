...
preservation drops to $0.35$---a $65\%$ silent substitution rate
...
(\cref{ch:formal-problem}, Proposition).  This structural violation
...
``flexibility'' or ``generality'' opens the door to Goodhart collapse:
...
\begin{itemize}[itemsep=6pt]
  ...
  \item \textbf{The tropical semiring is not claimed to be unique or
    optimal.}\quad
    We do not claim that the $(\min, +)$ tropical semiring
