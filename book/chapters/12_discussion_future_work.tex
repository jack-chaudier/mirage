...
classes: Class~A (pivot loss), Class~B (pivot displacement),
Class~C (phase collapse), and Class~D (semantic regret) and constructed a
...
\paragraph{Paper~03: Context Algebra~\citep{gaffney2026mirage} (Chapters~5, 7, 9).}
