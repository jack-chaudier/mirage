...
ADAPTER_DIR="${REPO_ROOT}/adapters/mirage_aware_v2"
RESULTS_CSV="${REPO_ROOT}/results/mirage_aware_eval_results.csv"
SUMMARY_CSV="${REPO_ROOT}/results/mirage_aware_eval_summary.csv"
